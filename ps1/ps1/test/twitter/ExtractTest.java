...
public class ExtractTest {
    ...
    public void testGetMentionedUsersOneMention() {
        ...
        assertEquals("expected one entry set", mentionedUsers.size(),1);
    }
    @Test
    ...
    @Test
    public void testGetMentionedUsersMoreThanOneUniqueMentions() {
    	Set<String> mentionedUsers = Extract.getMentionedUsers(Arrays.asList(tweet2, tweet3, tweet4, tweet5));
        
        assertEquals("expected one entry set", mentionedUsers.size(),4);
    }
    @Test
    public void testGetMentionedUsersOneTweetMoreThanOneUniqueMentions() {
    	Set<String> mentionedUsers = Extract.getMentionedUsers(Arrays.asList(tweet2));
        
        assertEquals("expected one entry set", mentionedUsers.size(),2);
    }
